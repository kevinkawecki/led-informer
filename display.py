    ...
    def setAlerts(self, alerts):
        ...
        try:
            ...
            for period in self.alert["periods"]:
                ...
                if count == len(self.alert["periods"]): 
            ...
            if day_1_end == day_end:
                alert_string = f"Outage: {day_1_start} {start_time} -> {day_1_end} {end_time} : {header}"
            else:
                alert_string = f"Outage: {day_1_start} {start_time} -> {day_1_end} {end_time} each day until {day_end} : {header}"
